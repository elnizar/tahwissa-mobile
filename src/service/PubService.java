...
public class PubService extends Observable {
    ...
    public static void addPub(Publication pub, String image) {
        ...
        ConnectionRequest request = new ConnectionRequest("http://localhost/tahwissa/web/app_dev.php/service/publication/add");
    ...
    public static List<Publication> getPublication() {
        ...
        ConnectionRequest request = new ConnectionRequest("http://localhost/tahwissa/web/app_dev.php/sercice/publicationService");
    ...
    public void removePub(Publication pub, Observer o) {
        ConnectionRequest request = new ConnectionRequest("http://localhost/tahwissa/web/app_dev.php/service/publication/del");
    ...
    public static void addComm(Commentaire comm) {
        ...
        ConnectionRequest request = new ConnectionRequest("http://localhost/tahwissa/web/app_dev.php/service/commentaire/add");
    ...
    public static List<Commentaire> getCommentaires(int id_pub) {
        ...
        ConnectionRequest request = new ConnectionRequest("http://localhost/tahwissa/web/app_dev.php/sercice/commentaireService");
