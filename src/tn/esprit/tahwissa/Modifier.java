...
public class Modifier implements Observer {
    ...
    private class numberFocusListener implements FocusListener {
        ...
        public void focusLost(Component cmp) {
            ...
            if (validateNumber((TextField) cmp, "") == false) {

                cmp.setUIID("inputError");
                f.refreshTheme();
            } else {

                cmp.setUIID("inputSuccess");
                f.refreshTheme();
            }
        }
    ...
    private class textFocusListener implements FocusListener {
        ...
        public void focusLost(Component cmp) {
            System.out.println("validating");
            if (validateRequired((TextField) cmp, "") == false) {
                cmp.setUIID("inputError");
                f.refreshTheme();
            } else {
                cmp.setUIID("inputSuccess");
    ...
    public void initFieldValues() {
        ...
        System.out.println(evenement.getDateHeureDepart());
    ...
    public boolean validate() {
        ...
        if (campingRadio.isSelected()) {
            ...
            evenement.setEvenementType("randonnée");
            TextField distanceParcourue = (TextField) uibuilder.findByName("distanceParcourue", container);
    ...
    public void pictureUpload(final Callback<String> resultURL) {
        ...
        for (int i = 0; i < selectedFiles.size(); i++) {
            ...
            if (picture != null) {
                String filestack = "https://www.filestackapi.com/api/store/S3?key=AGJj4N4lQRt2vx1CC2PCDz&filename=myPicture.jpg";
    ...
    public void picturesUploaded() {
        ...
        System.out.println(planning.size());
    ...
    public void update(Observable o, Object arg) {
        ...
        status.clear();
        ToastBar.showErrorMessage("Evenement mis a jour");
