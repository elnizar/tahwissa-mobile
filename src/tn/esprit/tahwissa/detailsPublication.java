...
public class detailsPublication implements Observer {
    ...
    public void start() {
        ...
        //String url = "http://localhost/tahwissa/web/app_dev.php/service/videoplayer?video_url=" + publication.getVideo_url();
       // BrowserComponent b = new BrowserComponent();
        ...
        Image image = URLImage.createToStorage(placeholder, path, "http://localhost/tahwissa/web/uploads/images/publications/" + publication.getImages().get(0).getChemin());
        System.out.println("Lien "+"http://localhost/tahwissa/web/" + publication.getImages().get(0).getChemin());
