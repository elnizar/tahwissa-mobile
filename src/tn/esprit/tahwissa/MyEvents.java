 ...
 */
public class MyEvents implements Observer {
        ...
        f.getToolbar().addSearchCommand((evt) -> {
            ...
            if (keyWord.length() >= 4) {
                ...
                for (int i = 0; i < events.size(); i++) {
                    ...
                    boolean statutMatched =  (event.getStatut().toLowerCase().indexOf(keyWord) != -1);
                    if ((descriptionMatched) || (destinationMatched) || (evenementTypeMatched) || (userNameMatched) || (userMailMatched) || (statutMatched)) {
                        results.add(event);
                    }
                }
                f.removeAll();
    ...
    public void initList(int from, int to, List<Evenement> evenements) {
        ...
        if (evenements.size() >= to) {
            for (int i = from; i < to; i++) {
                ...
                Label name = new Label(event.getStatut());
            ...
            for (int i = from; i < evenements.size(); i++) {
